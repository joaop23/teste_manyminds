...
<br>
<form action='<?php echo base_url("index.php/produtos/inserir"); ?>' method='post' enctype="multipart/form-data" >
      ...
      <fieldset class="border p-2">
        ...
        <div class="control-group ">
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="" id="cdProduto" name="cdProduto" placeholder="Digite um código">
          </div>
          <div class="form-group">
            <label for="txDescricao">Nome</label>
            <input type="text" class="form-control" value="" id="nmProduto" name="nmProduto" placeholder="Digite um nome">
          </div>
        </div>
      </fieldset>
    </div>
